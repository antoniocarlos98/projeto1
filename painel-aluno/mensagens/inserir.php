...
if($id == ""){
	...
	if($imagem == "sem-foto.jpg"){
		$res = $pdo->prepare("UPDATE mensagens SET titulo = :titulo, mensagem = :mensagem, professor = :professor, aluno = :aluno, data = curDate(), hora = curTime() WHERE id = '$id'");
	}else{
		$res = $pdo->prepare("UPDATE mensagens SET titulo = :titulo, mensagem = :mensagem, professor = :professor, arquivo = '$imagem', aluno = :aluno, data = curDate(), hora = curTime() WHERE id = '$id'");
	}
