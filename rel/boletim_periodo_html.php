...
<body>
	...
	<div class="container">
		...
		<p class="subtitulo" align="center"><b>BOLETIM <?php echo mb_strtoupper($nome_disc) ?> - <?php echo mb_strtoupper($nome_periodo) ?> -	<span class="<?php echo $classe_nota ?>"> <?php echo $total_notas ?> 
		PONTOS</b></p>
		</span>
		<br><br><br>


	<?php if($tot_modulos > 0){ ?>
